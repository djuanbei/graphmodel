...
//                       Argument rhs) {
//
//  if (first.type == NORMAL_VAR_ARG && second.type == NORMAL_VAR_ARG &&
//      rhs.type == CONST_ARG) {
