...
\index{rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}!align@{align}}
\index{align@{align}!rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}}
...
\index{rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}!allocate\_aligned@{allocate\_aligned}}
\index{allocate\_aligned@{allocate\_aligned}!rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}}
\subsubsection{\texorpdfstring{allocate\_aligned()}{allocate\_aligned()}}
{\footnotesize\ttfamily template$<$class Ch  = char$>$ \\
...
\index{rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}!allocate\_raw@{allocate\_raw}}
\index{allocate\_raw@{allocate\_raw}!rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}}
...
Clears the pool. This causes memory occupied by nodes allocated by the pool to be freed. Any nodes or strings allocated from the pool will no longer be valid. Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
\index{rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}!init@{init}}
\index{init@{init}!rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}}
...
\index{rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}!m\_alloc\_func@{m\_alloc\_func}}
\index{m\_alloc\_func@{m\_alloc\_func}!rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}}
\subsubsection{\texorpdfstring{m\_alloc\_func}{m\_alloc\_func}}
{\footnotesize\ttfamily template$<$class Ch  = char$>$ \\
alloc\+\_\+func$\ast$ \mbox{\hyperlink{classrapidxml_1_1memory__pool}{rapidxml\+::memory\+\_\+pool}}$<$ Ch $>$\+::m\+\_\+alloc\+\_\+func\hspace{0.3cm}{\ttfamily [private]}}
...
\index{rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}!m\_begin@{m\_begin}}
\index{m\_begin@{m\_begin}!rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}}
\subsubsection{\texorpdfstring{m\_begin}{m\_begin}}
{\footnotesize\ttfamily template$<$class Ch  = char$>$ \\
char$\ast$ \mbox{\hyperlink{classrapidxml_1_1memory__pool}{rapidxml\+::memory\+\_\+pool}}$<$ Ch $>$\+::m\+\_\+begin\hspace{0.3cm}{\ttfamily [private]}}
...
\index{rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}!m\_end@{m\_end}}
\index{m\_end@{m\_end}!rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}}
\subsubsection{\texorpdfstring{m\_end}{m\_end}}
{\footnotesize\ttfamily template$<$class Ch  = char$>$ \\
char$\ast$ \mbox{\hyperlink{classrapidxml_1_1memory__pool}{rapidxml\+::memory\+\_\+pool}}$<$ Ch $>$\+::m\+\_\+end\hspace{0.3cm}{\ttfamily [private]}}
...
\index{rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}!m\_free\_func@{m\_free\_func}}
\index{m\_free\_func@{m\_free\_func}!rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}}
\subsubsection{\texorpdfstring{m\_free\_func}{m\_free\_func}}
{\footnotesize\ttfamily template$<$class Ch  = char$>$ \\
...
\index{rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}!m\_ptr@{m\_ptr}}
\index{m\_ptr@{m\_ptr}!rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}}
...
\index{rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}!m\_static\_memory@{m\_static\_memory}}
\index{m\_static\_memory@{m\_static\_memory}!rapidxml::memory\_pool$<$ Ch $>$@{rapidxml::memory\_pool$<$ Ch $>$}}
